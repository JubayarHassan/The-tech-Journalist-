...
<div class="oceanwp-mb-field">
	<input type="hidden" class="butterbean-attachment-id" name="{{ data.field_name }}" value="{{ data.value }}">
		...
		<img class="butterbean-img" src="http://jubayarhassan.github.io/The-tech-Journalist-/wp-content/plugins/ocean-extra/includes/metabox/controls/image/{{ data.src }}" alt="{{ data.alt }}">
