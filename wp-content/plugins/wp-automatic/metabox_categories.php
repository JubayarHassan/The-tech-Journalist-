	...
	<div class="TTWForm">
		<div class="panes">
			...
			<div class="contains">
                ...
                </select> <input id="cg_camp_tax" type="hidden" value="" name="cg_camp_tax">
				...
				<div class="field f_100">
					<div class="option clearfix">
						...
						<div id="keyword_to_cat" class="field f_100">
							...
							<textarea name="cg_keyword_cat"></textarea>
               ...
               <div class="option clearfix">
		            ...
		            <div id="tags_c" class="field f_100">
		               <label for="field6">
		            	...
		            	<textarea name="cg_post_tags"></textarea>
                    	...
                    	<div id="random_tags_count" class="field f_100">
				               <label for="field6">
				                ...
				                <input value="" max="1000" min="1" name="cg_tags_limit" required="required" id="random_tags_count_field" class="ttw-range range" type="range">
		...
		<div id="field1zz-container" class="field f_100">
		 ...
		 <div class="option clearfix">
		            ...
		            <div id="keyword_to_tag" class="field f_100">
		               ...
		               <textarea name="cg_keyword_tag"></textarea>
               ...
               <div class="option clearfix">
		            ...
		            <div id="taxonmy_c" class="field f_100">
		               ...
		               <input value="" name="cg_tag_tax" type="text">
