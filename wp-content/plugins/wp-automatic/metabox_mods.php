		...
		<div class="panes">
		 ...
		 <div class="option clearfix">
		            ...
		            <div id="replace_regex" class="field f_100">
		               ...
		               <textarea name="cg_regex_replace"></textarea>
         ...
         <div id="replace_links" class="field f_100">
               <div class="option clearfix">
		            ...
		            <div id="replace_linkc" class="field f_100">
		               ...
		               <input value="" name="camp_replace_link" id="field6" type="text">
               ...
               <div class="option clearfix">
		            ...
		            <div id="replace_linkc_keywords" class="field f_100">
		               <label>
		                ...
		                <textarea name="cg_keywords_replace"></textarea>
               ...
               <div class="option clearfix">
		            ...
		            <div id="limit_content_c" class="field f_100">
		               <label for="field6">
		                ...
		                <input value="" max="20000" min="0" name="cg_content_limit" id="fieldlimit" required="required" class="ttw-range range" type="range">
		            ...
		            <div id="limit_title_c">
		              ...
		              <div class="field f_100">
			               <label>
			                ...
			                <input value="" max="20000" min="0" name="cg_title_limit" id="fieldlimit2" required="required" class="ttw-range range" type="range">
