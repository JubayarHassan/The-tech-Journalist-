               ...
               <div class="option clearfix">
		            ...
		            <div id="exact_match_c" class="field f_100">
		               <label for="field6">
		            	...
		            	<textarea name="camp_post_exact"></textarea>
               ...
               <div class="option clearfix">
		            ...
		            <div id="exact_execlude_c" class="field f_100">
		               <label for="field6">
		            	...
		            	<textarea name="camp_post_execlude"></textarea>
               ...
               <div class="option clearfix">
		            ...
		            <div id="exact_match_regex_c" class="field f_100">
		               <label for="field6">
		            	...
		            	<textarea name="cg_camp_post_regex_exact"></textarea>
               ...
               <div class="option clearfix">
		            ...
		            <div id="exclude_match_regex_c" class="field f_100">
		               <label for="field6">
		            	...
		            	<textarea name="cg_camp_post_regex_exclude"></textarea>
		            	<div class="description">*default delimiter is {} <br>*one REGEX per line</div>
 		            </div>
         	...
         	<div class="option clearfix">
			            ...
			            <div id="limit_min_length_c" class="field f_100">
			               <label>
			                ...
			                <input value="" max="20000" min="0" name="cg_min_length" required="required" class="ttw-range range" id="cg_min_length" type="range">
         	...
         	<div class="option clearfix">
			            ...
			            <div id="limit_max_length_c" class="field f_100">
			               <label>
			                ...
			                <input value="" max="20000" min="0" name="cg_max_length" required="required" class="ttw-range range" id="cg_max_length" type="range">
