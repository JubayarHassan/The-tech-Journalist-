	...
	<div class="TTWForm">
		<div class="panes">
			...
			<div id="field6-container" class="field f_100">
				<label for="field6"> Post title template </label> <input value="" name="camp_post_title" id="field6" required="required" type="text">
			</div>
			...
			<div id="field11-container" class="field f_100">
				...
				<textarea required="required" rows="5" cols="20" name="camp_post_content" id="field11"></textarea>
               ...
               <div class="option clearfix">
		            ...
		            <div id="default_c" class="field f_100">
		               <label for="field6">
		            	...
		            	<textarea name="cg_default_tags"></textarea>
               ...
               <div class="option clearfix">
		            ...
		            <div id="incdefault_c" class="field f_100">
		               <label for="field6">
		            	...
		            	<textarea name="cg_adjust_tags"></textarea>
