                    ...
                    <br>
		                ...
		                <div class="option clearfix">
		                    ...
		                    <div id="minimum_image_width">
		                     ...
		                     <input value="" max="1000" min="0" name="cg_minimum_width" id="cg_minimum_width_f" required="required" class="ttw-range range" type="range">
			            ...
			            <div id="wp_automatic_featured_list" class="field f_100">
			               <label for="field6">
			            	...
			            	<textarea name="cg_thmb_list"></textarea>
