var tdcComposerBlocksApi={};(function(c){tdcComposerBlocksApi={items:[],item:function(){this.blockUid="";this.callbackDelete=function(b){};this.callbackAdd=function(b){}},addItem:function(b){tdcComposerBlocksApi.items.push(b);b.callbackAdd(b.blockUid)},deleteItem:function(b){if(!c.isUndefined(b)){for(var a=0;a<tdcComposerBlocksApi.items.length;a++)if(tdcComposerBlocksApi.items[a].blockUid===b)return tdcComposerBlocksApi.items[a].callbackDelete(b),tdcComposerBlocksApi.items.splice(a,1),!0;return!1}}}})(_);
var tdcDebug;
